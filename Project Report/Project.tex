...
Targeted Aspect-Based Sentiment Analysis (TABSA) aims to determine sentiment toward specific targets, such as individuals or entities \cite{tabsa}. This idea is particularly important in the context of FPL sentiment analysis because posts often mention multiple players. Identifying sentiment toward specific players is far more valuable than assessing the overall sentiment of a post. Sun et al. \cite{sun} proposed a methodology using BERT to address TABSA by framing it as a sentence-pair classification task. Their approach involves constructing an auxiliary sentence, such as "What do you think of the safety of location - 1?", and pairing it with the relevant context to identify the sentiment toward the specific target. Building on this idea, Hoang et al. \cite{hoang} advanced the methodology in 2019, achieving state-of-the-art results across various sentiment analysis benchmarks.
% -------------------------------------------------------------
% SUMMARY
% -------------------------------------------------------------
